    ...
    public partial class Test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignupMessages", x => x.SignupMessageId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoursesCategoryCategoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_CoursesCategories_CoursesCategoryCategoryId",
                        column: x => x.CoursesCategoryCategoryId,
                        principalTable: "CoursesCategories",
                        principalColumn: "CategoryId");
                    table.ForeignKey(
                        name: "FK_Courses_SignupMessages_SignupMessageId",
                        column: x => x.SignupMessageId,
                        principalTable: "SignupMessages",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseDateId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Signups", x => x.SignupId);
                    table.ForeignKey(
                        name: "FK_Signups_CourseDates_CourseDateId",
                        column: x => x.CourseDateId,
                        principalTable: "CourseDates",
                        principalColumn: "CourseDateId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Signups_CourseDates_CourseDateId1",
                        column: x => x.CourseDateId1,
                        principalTable: "CourseDates",
                        principalColumn: "CourseDateId");
                    table.ForeignKey(
                        name: "FK_Signups_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonVideos_Lessons_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_CoursesCategoryCategoryId",
                table: "Courses",
                column: "CoursesCategoryCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Courses_SignupMessageId",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Signups_CourseDateId",
                table: "Signups",
                column: "CourseDateId");

            migrationBuilder.CreateIndex(
                name: "IX_Signups_CourseDateId1",
                table: "Signups",
                column: "CourseDateId1",
                unique: true,
                filter: "[CourseDateId1] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Signups_CourseId",
                table: "Signups",
                column: "CourseId");
