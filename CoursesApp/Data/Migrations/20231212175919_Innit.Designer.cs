...
namespace AplikacjaMetodyki.Data.Migrations
{
    ...
    [Migration("20231212175919_Innit")]
    partial class Innit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoursesApp.Models.CourseDate", b =>
                {
            ...
            modelBuilder.Entity("CoursesApp.Models.CoursesCategory", b =>
                {
            ...
            modelBuilder.Entity("CoursesApp.Models.ForumCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoursesApp.Models.ForumPost", b =>
                {
            ...
            modelBuilder.Entity("CoursesApp.Models.LessonVideo", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoursesApp.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("CoursesApp.Models.Signup", b =>
                {
            ...
            modelBuilder.Entity("CoursesApp.Models.SignupMessage", b =>
                {
                    b.Property<int>("SignupMessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoursesApp.Models.Course", b =>
                {
                    b.HasOne("CoursesApp.Models.CoursesCategory", "CoursesCategory")
                        .WithMany()
                        .HasForeignKey("CourseCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CoursesApp.Models.CoursesCategory", null)
                        .WithMany("Courses")
                        .HasForeignKey("CoursesCategoryCategoryId");

                    b.HasOne("CoursesApp.Models.SignupMessage", "SignupMessage")
                        .WithOne("Course")
                        .HasForeignKey("CoursesApp.Models.Course", "SignupMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoursesApp.Models.ForumPost", b =>
                {
                    b.HasOne("CoursesApp.Models.ForumCategory", "ForumCategory")
                        .WithMany("ForumPosts")
            ...
            modelBuilder.Entity("CoursesApp.Models.LessonVideo", b =>
                {
                    b.HasOne("CoursesApp.Models.Lesson", "Lesson")
                        .WithOne("LessonVideo")
                        .HasForeignKey("CoursesApp.Models.LessonVideo", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoursesApp.Models.Signup", b =>
                {
                    b.HasOne("CoursesApp.Models.CourseDate", "CourseDate")
                        .WithMany()
                        .HasForeignKey("CourseDateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CoursesApp.Models.CourseDate", null)
                        .WithOne("Signup")
                        .HasForeignKey("CoursesApp.Models.Signup", "CourseDateId1");
